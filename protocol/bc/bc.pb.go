...
type Claim struct {
	WitnessDestination *ValueDestination `protobuf:"bytes,1,opt,name=witness_destination,json=witnessDestination" json:"witness_destination,omitempty"`
	ControlProgram     *Program          `protobuf:"bytes,2,opt,name=ControlProgram" json:"ControlProgram,omitempty"`
	WitnessArguments   [][]byte          `protobuf:"bytes,3,rep,name=witness_arguments,json=witnessArguments,proto3" json:"witness_arguments,omitempty"`
	Peginwitness       [][]byte          `protobuf:"bytes,4,rep,name=Peginwitness,proto3" json:"Peginwitness,omitempty"`
...
func (*Claim) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{17} }
...
func (m *Claim) GetControlProgram() *Program {
	if m != nil {
		return m.ControlProgram
	}
	return nil
...
var fileDescriptor0 = []byte{
	...
	,
}
